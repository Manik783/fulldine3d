...
const EditDishClient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedDish = {
      ...
      category3,
      image,
      glb_url: dish.glb_url, // Include GLB URL but remove from form
      usdz_url: dish.usdz_url, // Include USDZ URL but remove from form
    };
    ...
    try {
      await axios.put(
        ...
        }/client/update_dish/${rest_id}/${item_id}`,
        updatedDish,
        {
          headers: {
